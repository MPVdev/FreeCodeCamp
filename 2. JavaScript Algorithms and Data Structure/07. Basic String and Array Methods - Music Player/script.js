...
const allSongs = [{
    ...
    duration: "4:25",
    src: "../00. Assets/mp3/scratching-the-surface.mp3",
  },
  {
    id: 1,
    ...
    artist: "Quincy Larson",
    duration: "4:15",
    src: "../00. Assets/mp3/can't-stay-down.mp3",
  },
  {
    id: 2,
    ...
    artist: "Quincy Larson",
    duration: "3:51",
    src: "../00. Assets/mp3/still-learning.mp3",
  },
  {
    id: 3,
    ...
    artist: "Quincy Larson",
    duration: "3:34",
    src: "../00. Assets/mp3/cruising-for-a-musing.mp3",
  },
  {
    id: 4,
    ...
    artist: "Quincy Larson",
    duration: "3:35",
    src: "../00. Assets/mp3/never-not-favored.mp3",
  },
  {
    id: 5,
    ...
    artist: "Quincy Larson",
    duration: "3:12",
    src: "../00. Assets/mp3/from-the-ground-up.mp3",
  },
  {
    id: 6,
    ...
    artist: "Quincy Larson",
    duration: "3:25",
    src: "../00. Assets/mp3/walking-on-air.mp3",
  },
  {
    id: 7,
    ...
    artist: "Quincy Larson",
    duration: "3:52",
    src: "../00. Assets/mp3/cant-stop-me-cant-even-slow-me-down.mp3",
  },
  {
    id: 8,
    ...
    artist: "Quincy Larson",
    duration: "3:10",
    src: "../00. Assets/mp3/the-surest-way-out-is-through.mp3",
  },
  {
    id: 9,
    ...
    artist: "Quincy Larson",
    duration: "2:43",
    src: "../00. Assets/mp3/chasing-that-feeling.mp3",
  },
];
...
const setPlayerDisplay = () => {
  ...
  const currentTitle = userData.currentSong ? userData.currentSong.title : "";
  const currentArtist = userData.currentSong ? userData.currentSong.artist : "";
...
const highlightCurrentSong = () => {
  ...
  const songToHighlight = document.getElementById("song-" + (userData.currentSong ? userData.currentSong.id : ""));
